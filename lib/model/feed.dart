...
class NewsFeed {  
  ...
  List<Event> dummyEvents = [
    Event(01, "/Path to Image1", "Pengajian Ustad Z" , "Surabaya","Ayo Gabung Sama Event Ustad Z ini!", 1),
    Event(02, "/Path to Image2", "Pengajian Ustadza Y" ,"Malang", "Ayo Gabung Sama Event Ustadza Y ini!", 1),
    Event(03, "/Path to Image3", "Pengajian Ustad X" , "Jakarta", "Ayo Gabung Sama Event Ustad X ini!",1),
    Event(04, "/Path to Image3", "Pengajian Ustad" + lorepIpsum , lorepIpsum, lorepIpsum, 1),
  ];
...
class Event{
  ...
  String caption;
  int newsType;  
  Event (this.eventID, this.imagePath, this.eventName, this.eventLocation, this.caption, this.newsType);  
